        ...
        <>
            ...
            <div className='main'>
                ...
                <div className='settings-nav'>
                    <SettingsCard url='/settings/update' text='Edit' arrowColor='#9381FF' borderColor='#9381FF' svg={
                    ...
                    <SettingsCard url='/password/update'  text='Change password' arrowColor='#9381FF' borderColor='#9381FF' svg={
                    ...
                    <SettingsCard url='' text='Log out' textColor='#FC2A2A' arrowColor='#FC2A2A' borderColor='#FC2A2A' onClick={logout} svg={
